...
#if 1
#define ONLINE_ST_INTERVAL_MS       (1500)//(320)
#define ONLINE_ST_NODE_MAX_NUM      (1600)//(64) // not equal to MESH_NODE_MAX_NUM, because LPN is no online status.
#define	MESH_NODE_ST_PAR_LEN        (3)//(5)//(3)  //MAX: 7, because sizeof(node_data)  in mesh_node_flush_status()      //lumen-rsv, exclude dev_adr and sn.
//Note: ONLINE_STATUS_TIMEOUT may be set longer after set ONLINE_ST_NODE_MAX_NUM or MESH_NODE_ST_VAL_LEN larger, 
#define ONLINE_STATUS_TIMEOUT       15000//3000 //ms
