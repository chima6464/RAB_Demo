...
#else
#define FAST_PROVISION_ENABLE		 1//0
#endif
...
#define SUBSCRIPTION_SHARE_EN		1
#define AIS_ENABLE					0
#define PROVISION_FLOW_SIMPLE_EN    1//0
#endif
...
#define LIGHT_TYPE_SEL				LIGHT_TYPE_PANEL
		#endif
	#else
#define LIGHT_TYPE_SEL				LIGHT_TYPE_DIM//LIGHT_TYPE_DIM//LIGHT_TYPE_CT	//
	#endif
#endif
#endif
...
#if ((LIGHT_TYPE_CT_EN) || (LIGHT_TYPE_HSL_EN) || (LIGHT_TYPE_SEL == LIGHT_TYPE_XYL) || (LIGHT_TYPE_SEL == LIGHT_TYPE_DIM))
    #if((WIN32) || (TESTCASE_FLAG_ENABLE))
#define MD_LIGHT_CONTROL_EN			1	// must 1
    #else
#define MD_LIGHT_CONTROL_EN			1//0
    #endif
#else
...
#define MD_POWER_ONOFF_EN           MD_DEF_TRANSIT_TIME_EN 	// because both of them save in same flash sector.
    #endif
#define MD_TIME_EN                  1//0
#define MD_SCENE_EN                 1//0
#define MD_SCHEDULE_EN              MD_TIME_EN  // because both of them save in same flash sector.
#define MD_PROPERTY_EN				1//0
#define	MD_LOCATION_EN				0	// location,sensor,battery use same flash addr, but one sector max store 6 models
#define MD_BATTERY_EN				0
#define MD_DF_EN					0
#define MD_SBR_EN					0
...
#define MD_SERVER_EN                1   // SIG and vendor MD
#define MD_CLIENT_EN                1//0   // just SIG MD
    #if(DUAL_VENDOR_EN)
#define MD_CLIENT_VENDOR_EN         0
...
#define MD_CLIENT_VENDOR_EN         0
    #endif
#define MD_VENDOR_2ND_EN            (DEBUG_VENDOR_CMD_EN && MI_API_ENABLE)
#define MD_SENSOR_SERVER_EN			1//0	// MD_SERVER_EN
    #if MD_LIGHT_CONTROL_EN
#define MD_SENSOR_CLIENT_EN		    1	// must 1
    #else
#define MD_SENSOR_CLIENT_EN		    1//0	// MD_CLIENT_EN
    #endif
#endif
...
#define KEEP_ONOFF_STATE_AFTER_OTA	1//0
