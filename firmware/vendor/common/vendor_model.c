...
mesh_cmd_sig_func_t mesh_cmd_vd_func[] = {
    ...
    GY_MESH_CMD_VENDOR_FUNCTION_POWER_GET,
    GY_MESH_CMD_VENDOR_FUNCTION_GENERIC_GET,
    GY_MESH_CMD_VENDOR_FUNCTION_GENERIC_SET,
    GY_MESH_CMD_VENDOR_FUNCTION_GENERIC_SET_UNACK,
    GY_MESH_CMD_VENDOR_FUNCTION_SENSOR_GET,
    GY_MESH_CMD_VENDOR_FUNCTION_SENSOR_SET,
};
