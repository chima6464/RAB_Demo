...
#define STRING_VENDOR			L"RAB"
#define STRING_PRODUCT			L"Lightcloud Blue"
#define STRING_SERIAL			L"Turing"

#define DEV_NAME                "Lightcloud Blue"//"SigMesh"
...
#define TRANSITION_TIME_DEFAULT_VAL	0
	#else
#define TRANSITION_TIME_DEFAULT_VAL (0)//(GET_TRANSITION_TIME_WITH_STEP(1, TRANSITION_STEP_RES_1S)) // (0x41)  // 0x41: 1 second // 0x00: means no default transition time
	#endif
#endif
#endif
...
#define BLT_SOFTWARE_TIMER_ENABLE		1//0
#endif
...
#elif(PCBA_8258_SEL == PCBA_8258_C1T140A3_V1_1)
#define PWM_R       GY_DIM_PIN//GPIO_PWM2ND4    //red
#define PWM_G       GPIO_PWM0NA0    //green
#define PWM_B       GPIO_PWM1ND3    //blue
#define PWM_W       0//GPIO_PWM3D2		//yellow as white
